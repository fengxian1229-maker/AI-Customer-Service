...
FINAL_REPLY_SEMANTIC_CONSTRAINTS = load_prompt("final_reply_semantic_constraints.md")


TEXT_ONLY_STREAMING_OUTPUT_INSTRUCTION = load_prompt("text_streaming_output.md")


GLOBAL_FINAL_REPLY_CONSTRAINTS = render_prompt(
    "final_reply_system.md",
    final_reply_semantic_constraints=FINAL_REPLY_SEMANTIC_CONSTRAINTS,
)
